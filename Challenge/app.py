...
def record_address(req):
    ...
    cursor.execute("SELECT * FROM found_objects WHERE object_name = '" + object_name + "';")
...
if __name__ == '__main__':
    ...
    with Configurator() as config:
        ...
        config.add_route('object', '/{object_name}')
        ...
        config.add_route('record', '/record/{object_name}')
        config.add_view(record_address, route_name='record')
